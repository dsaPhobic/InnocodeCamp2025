...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            // Kiểm tra session storage (nếu có)
            const sessionSuccess = sessionStorage.getItem('successMessage');
            const sessionError = sessionStorage.getItem('errorMessage');
            
            if (sessionSuccess) {
                document.getElementById('successMessage').textContent = sessionSuccess;
                document.getElementById('successAlert').style.display = 'block';
                sessionStorage.removeItem('successMessage');
            }
            
            if (sessionError) {
                document.getElementById('errorMessage').textContent = sessionError;
                document.getElementById('errorAlert').style.display = 'block';
